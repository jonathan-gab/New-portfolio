...
<section class="page-section  mb-0" id="cursus">
        <div class="container">
            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="../Portfolio/img/em.jpg" alt="" /></div>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="../Portfolio/img/iut.png" alt="" /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                ...
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            ...
                            <h4 class="subheading">Lycée Jean Jacqs Rousseau</h4>
                        </div>
